...
sub do_one_dir{
    ...
    foreach(@vfiles){
        ...
        if ( $filename =~ /\.description$/i ){
            print "YES>> $filename \n";
            $dest = $subtitled_dir . $filename;
            my $cmd = "mv $full_video_filename $dest ";
            print $cmd . "\n";
            ##`cmd`;
        }elsif( $filename =~ /cname/i ){
            print "ooo ooo cname -- $filename\n";
            $dest = $subtitled_dir . $filename;
            my $cmd = "mv $full_video_filename $dest ";
            print $cmd . "\n";
            ##`cmd`;
        } elsif( $filename =~ /^[.]+$/ ){
            print "ooo aaa ooo system dot file -- $filename\n";
            ;
        } elsif( $filename =~ /^\s*$/ ){
            print "ooo ooo system EMPTY file -- $filename\n";
            ;
        } elsif (-e $full_video_filename){
            print "do the job --------------------\n";
            print $full_video_filename . "\n";
            print "$src_dir, $filename, -->-->-->-->-->--> $subtitled_dir \n";
